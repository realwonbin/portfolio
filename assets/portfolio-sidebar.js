(() => {
  ...
  aside.innerHTML = `
    <div class="legacy-sidebar-head">
      ...
      <nav aria-label="사이트 메뉴"><a href="${rootPrefix}about.html?v=9">시작</a><a href="${rootPrefix}texts.html?v=9">생각</a><a href="${contentPrefix}resume.html?v=9">이력</a><a href="https://www.instagram.com/iam2020/" target="_blank" rel="noopener noreferrer">인스타그램</a></nav>
    </div>
